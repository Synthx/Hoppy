...
class BeerStyleRepartitionDialog extends StatefulWidget {
  ...
  @override
  State createState() => _BeerStyleRepartitionDialogState();
}

class _BeerStyleRepartitionDialogState
    extends State<BeerStyleRepartitionDialog> {
  void _closeDialog() {
    context.pop();
  }
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      ...
                      itemCount: styleRepartition.length,
                      shrinkWrap: true,
